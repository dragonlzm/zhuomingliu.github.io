...
<div style="display: flex; flex-direction: row; align-items: center; margin-top: 10px; margin-bottom: 1em;">
    ...
    <div>
        ...
        <p style="font-size: 15px;">The IEEE/CVF Conference on Computer Vision and Pattern Recognition 2025 (CVPR 2025).</p>
        <p style="font-size: 15px;">Zhuoming Liu, Yiquan Li, Khoi Duc Nguyen, Yiwu Zhong, Yin Li</p>
...
<div style="display: flex; flex-direction: row; align-items: center; margin-top: 10px; margin-bottom: 1em;">
    ...
    <div>
        ...
        <p style="font-size: 15px;">Under Review.</p>
        <p style="font-size: 15px;">Yiwu Zhong, Zhuoming Liu, Yin Li, Liwei Wang</p>
