...
<div style="display: flex; flex-direction: row; align-items: center; margin-top: 10px; margin-bottom: 1em;">
    ...
    <div>
        ...
        <p style="font-size: 15px; margin-bottom: -0.1em;">Zhuoming Liu, Yiquan Li, Khoi Duc Nguyen, Yiwu Zhong, Yin Li</p>
...
<div style="display: flex; flex-direction: row; align-items: center; margin-top: 10px; margin-bottom: 1em;">
    ...
    <div>
        ...
        <p style="font-size: 15px; margin-bottom: -0.1em;">Yiwu Zhong, Zhuoming Liu, Yin Li, Liwei Wang</p>
