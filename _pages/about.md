...
<div style="display: flex; flex-direction: row; align-items: center; margin-top: 10px; margin-bottom: 1em;">
    ...
    <div>
        ...
        <p style="font-size: 12px; margin-bottom: -0.2em;">The IEEE/CVF Conference on Computer Vision and Pattern Recognition 2025</p>
...
<div style="display: flex; flex-direction: row; align-items: center; margin-top: 10px; margin-bottom: 1em;">
    ...
    <div>
        ...
        <p style="font-size: 12px; margin-bottom: -0.2em;">Under Review.</p>
